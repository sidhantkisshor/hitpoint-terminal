    ...
    <div className="bento-item col-span-12 md:col-span-12 lg:col-span-5 row-span-1">
      <div className="item-header">
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-0.5 bg-white/[0.03] p-0.5 rounded-full border border-white/[0.04]">
            <button
              onClick={() => setDisplayMode('chart')}
              className={`text-[10px] px-2.5 py-1 rounded-full transition-all font-display ${
                displayMode === 'chart'
                  ? 'bg-[#c4f82e] text-black font-semibold'
      ...
      <div className="relative h-full min-h-[300px] sm:min-h-[400px] rounded-lg overflow-hidden">
        ...
        {mounted && displayMode === 'coinglass' && (
          <div className="w-full h-full flex flex-col">
            <iframe
              ...
              loading="lazy"
            />
            <div className="mt-2 p-2 bg-white/[0.03] rounded-lg text-center">
              <a
                href="https://www.coinglass.com/LiquidationData"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[10px] sm:text-xs text-[#5a5a5a] hover:text-[#c4f82e] transition-colors"
              >
